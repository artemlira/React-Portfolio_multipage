  ...
  projects: {
    smallProjects: [
      ...
      },
      {
        ...
        fullDescriptionUA:
          "Ціль гри розтавити всі кубики по зростанню від 1 до 15",
        fullDescriptionEN:
    ...
    completeApps: [
      ...
      },
      {
        ...
        shortDescriptionUA:
          "Багатосторінковий Інтернет магазин кавової продукції Millor.",
      ...
      },
      {
        ...
        shortDescriptionUA:
          "Сайт для здорового харчування, з реалізацією замовлення їжі",
        shortDescriptionEN:
      ...
      },
      {
        ...
        shortDescriptionUA:
          "Односторінковий адаптивний статичний сайт алкогольної продукції Haus.",
        shortDescriptionEN:
          "One-page responsive static website for Haus alcohol products.",
        fullDescriptionUA:
          "Сайт алкогольної продукції. Застосунок написано з використанням збірника пакетів Gulp.",
        fullDescriptionEN:
          "Website for alcoholic beverages. The application is written using the Gulp package bundle.",
        git: "https://github.com/artemlira/hause",
      ...
      },
      {
        ...
        fullDescriptionUA:
          "Дитяча гра. Застосунок написано з використанням фреймворка React.js і його хуків useState, useEffect, useRef і useContext. Для реалізації анімації використовувалась бібліотека Framer Motion, для БД та авторизації Firebase",
        fullDescriptionEN:
          "Children's game. The application was written using the React.js framework and its useState, useEffect, useRef, and useContext hooks. The Framer Motion library was used to implement the animation, and Firebase was used for the database and authorization.",
      ...
      },
      {
        ...
        shortDescriptionUA: "Фуллстак приложение. Портфоліо робіт Ліри Артема",
        shortDescriptionEN:
